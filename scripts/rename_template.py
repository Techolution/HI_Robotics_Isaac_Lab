...
It renames all the occurrences of hi_robotics_isaac_lab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "hi_robotics_isaac_lab"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the hi_robotics_isaac_lab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "hi_robotics_isaac_lab", "hi_robotics_isaac_lab"),
            os.path.join(root_dir_path, "exts", "hi_robotics_isaac_lab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "hi_robotics_isaac_lab"), os.path.join(root_dir_path, "exts", new_name))
